...
const { withCourse, withLessons } = require('../middleware/withCourseAndLesson');
const protect = require('../middleware/protect');

const router = express.Router();

router.get('/courses/:courseId/lessons/:id', protect, withCourse, viewController.getLesson);
router.post('/courses/:courseId/lessons/:id', protect, withCourse, withLessons, viewController.updateLessonComments);
